...
outFeatureClass = "Challenge5_Anguilla_Pishagqua_Fishnet.shp"  # Name of output fishnet

# Set the origin of the fishnet

originCoordinate = str(XMin) + " " + str(YMin)  # Left bottom of our point data
yAxisCoordinate = str(XMin) + " " + str(YMin + 2.0)  # This sets the orientation on the y-axis, so we head north
cellSizeWidth = "0.0125"
cellSizeHeight = "0.0125"
...
if arcpy.Exists(outFeatureClass):
    print("Created Anguilla Fishnet file successfully!")

# 4. Undertake a Spatial Join to join the fishnet to the observed points.

target_features="Challenge5_Anguilla_Pishagqua_Fishnet.shp"
join_features="Challenge5_Anguilla_Pishagqua_Output.shp"
out_feature_class="Challenge5_Anguilla_Pishagqua_HeatMap.shp"
